...
ECHO.CALL $(SolutionDir)scripts\git-vs-versioninfo.bat "$(ProjectDir)" "$(ProjectDir)versioninfo.h" "$(RootNamespace)" "$(ProjectName)" "$(SolutionName)"
ECHO.
GOTO END
...
IF DEFINED fLEAVE_NOW GOTO END
CALL :GET_VS_DETAILS
IF DEFINED CACHE_FILE CALL :WRITE_CACHE
CALL :SET_DETAILS
...
IF [%COMMITTISH%] NEQ [] SET COMMITTISH=%COMMITTISH:~1%
...
IF DEFINED fGIT_AVAILABLE (
	...
	SET PATCHCOUNT=0
	SET vMAJOR_PATCHES=0
	SET vMINOR_PATCHES=0
	SET vMAINT_PATCHES=0
	SET vPATCH_PATCHES=0
)
...
ECHO.namespace build_info >> "%HEADER_OUT_FILE%"
ECHO.{ >> "%HEADER_OUT_FILE%"
ECHO.    // %SW_NAME% v%VERSION% - %vTYPE% >> "%HEADER_OUT_FILE%"
ECHO.    // Build: %FULL_VERSION% (%vBUILD%) >> "%HEADER_OUT_FILE%"
ECHO. >> "%HEADER_OUT_FILE%"
ECHO.    static constexpr const char *const project = %SW_NAME%
ECHO.    >> "%HEADER_OUT_FILE%"
ECHO.    namespace version >> "%HEADER_OUT_FILE%"
ECHO.    { >> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		short_str			= "%VERSION%";				>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		build				= "%FULL_VERSION%";			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		interface			= "%vINTERFACE%";			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				patch_level			= %PATCH_LEVEL%;			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				patch_count			= %PATCHCOUNT%;				>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		patch_level_identifier= "%PATCH_LEVEL_IDENTIFIER%"; >> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		committish			= "%COMMITTISH%";			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		release_type		= "%vTYPE%";			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		build_type			= "%vBUILD%";				>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const bool			is_onversioned		= %fNO_VCS%;				>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const bool			is_patched			= %fPATCHED%;				>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const bool			is_private			= %fPRIVATE%;				>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const bool			is_pre_release		= %fPRE_RELEASE%;			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				major				= %vMAJOR%;					>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				minor				= %vMINOR%;					>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				maintenaince		= %vMAINT%;					>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				bugfix				= %vPATCH%;					>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				patches_major		= %vMAJOR_PATCHES%;			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				patches_minor		= %vMINOR_PATCHES%;			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				patches_maintenaince	= %vMAINT_PATCHES%;		>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				patches_bugfix		= %vPATCH_PATCHES%;			>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		product_version		= "%VERSION_PRODUCT%";		>> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		technical_version	= "%VERSION_TECHNICAL%";	>> "%HEADER_OUT_FILE%"
ECHO.    } >> "%HEADER_OUT_FILE%"
ECHO. >> "%HEADER_OUT_FILE%"
ECHO.    namespace generator_version >> "%HEADER_OUT_FILE%"
ECHO.    { >> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const int				version				= %PLUGIN_API_VERSION%; >> "%HEADER_OUT_FILE%"
ECHO.        static constexpr const char *const		technical_version	= "%PLUGIN_API_VERSION_TECHNICAL%"; >> "%HEADER_OUT_FILE%"
ECHO.    } >> "%HEADER_OUT_FILE%"
ECHO.} >> "%HEADER_OUT_FILE%"
GOTO :EOF
